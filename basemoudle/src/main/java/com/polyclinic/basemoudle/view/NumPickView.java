...
public class NumPickView extends View {
    ...
    public NumPickView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < ta.getIndexCount(); i++) {
            ...
            if (index == R.styleable.NumPickView_totalNum) {
            ...
            } else if (index == R.styleable.NumPickView_showNum) {
                mShowNum = ta.getInteger(index, 6);
            } else if (index == R.styleable.NumPickView_textColor) {
...
//        textSize = DensityUtils.sp2px(getContext(), 22);
